...
class OnboardingActivityWidget extends StatefulWidget {
  ...
  _OnboardingActivityWidgetState createState() =>
      _OnboardingActivityWidgetState();
}

class _OnboardingActivityWidgetState extends State<OnboardingActivityWidget> {
  late OnboardingActivityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingActivityModel());
  }
                ...
                Expanded(
                  child: Container(
                    ...
                    child: custom_widgets.TextPickerWidget(
                      width: double.infinity,
                      height: double.infinity,
                      initialValue: FFAppState().activityLevel,
                      data: FFAppState().activities,
                      mode: 'activity',
